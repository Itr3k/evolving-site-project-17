...
const DocumentIntelligence = () => {
  const solution = solutionDetails['document-intelligence'];

  return (
    <PageLayout>
      <PageMeta 
        title="Document Intelligence - AI OCR & Data Extraction"
        description="We provide document intelligence systems with 99%+ accuracy. Los Angeles AI consultant specializing in OCR and data extraction for Southern California businesses."
        keywords="document intelligence Los Angeles, AI OCR Southern California, data extraction services, document processing AI, intelligent document processing"
        canonical="https://elevatedai.co/solutions/document-intelligence"
      />
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: solution.name, url: "https://elevatedai.com/solutions/document-intelligence" }
        ]}
      />
      ...
      <SectionContainer background="default" padding="large" className="text-center">
        <div className="max-w-4xl mx-auto space-y-6 animate-on-scroll">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <Link to="/contact?solution=document-intelligence">
      ...
      <SectionContainer background="gradient" padding="large">
        <div className="max-w-4xl mx-auto text-center space-y-6 animate-on-scroll">
          <Heading2>Ready to Unlock Your Document Data?</Heading2>
          <Body className="text-white/70 max-w-2xl mx-auto">
            Join leading companies using document intelligence to extract insights from any document format.
          </Body>
