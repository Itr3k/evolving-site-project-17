...
const IntelligentAutomation = () => {
  const solution = solutionDetails['intelligent-automation'];

  return (
    <PageLayout>
      <PageMeta 
        title="Intelligent Automation - AI-Powered Workflow Automation"
        description="We provide intelligent automation systems that reduce manual work by 80%. Los Angeles AI consultant specializing in process automation for Southern California businesses."
        keywords="intelligent automation Los Angeles, AI workflow automation, process automation Southern California, AI automation services, intelligent process automation"
        canonical="https://elevatedai.co/solutions/intelligent-automation"
      />
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: solution.name, url: "https://elevatedai.com/solutions/intelligent-automation" }
        ]}
      />
      ...
      <SectionContainer background="default" padding="large" className="text-center">
        <div className="max-w-4xl mx-auto space-y-6 animate-on-scroll">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <Link to="/contact?solution=intelligent-automation">
      ...
      <SectionContainer background="gradient" padding="large">
        <div className="max-w-4xl mx-auto text-center space-y-6 animate-on-scroll">
          <Heading2>Ready to Transform Your Workflows?</Heading2>
          <Body className="text-white/70 max-w-2xl mx-auto">
            Join leading companies using intelligent automation to eliminate manual work and accelerate growth.
          </Body>
