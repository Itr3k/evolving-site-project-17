...
const DecisionIntelligence = () => {
  const solution = solutionDetails['decision-intelligence'];

  return (
    <PageLayout>
      <PageMeta 
        title="Decision Intelligence - AI-Powered Analytics & Insights"
        description="We provide decision intelligence systems with 94% forecasting accuracy. Los Angeles AI consultant specializing in predictive analytics for Southern California businesses."
        keywords="decision intelligence Los Angeles, AI analytics Southern California, predictive analytics, AI forecasting, data intelligence services"
        canonical="https://elevatedai.co/solutions/decision-intelligence"
      />
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: solution.name, url: "https://elevatedai.com/solutions/decision-intelligence" }
        ]}
      />
      ...
      <SectionContainer background="default" padding="large" className="text-center">
        <div className="max-w-4xl mx-auto space-y-6 animate-on-scroll">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <Link to="/contact?solution=decision-intelligence">
      ...
      <SectionContainer background="gradient" padding="large">
        <div className="max-w-4xl mx-auto text-center space-y-6 animate-on-scroll">
          <Heading2>Ready to Make Data-Driven Decisions?</Heading2>
          <Body className="text-white/70 max-w-2xl mx-auto">
            Join leading companies using decision intelligence to predict outcomes and optimize strategies.
          </Body>
