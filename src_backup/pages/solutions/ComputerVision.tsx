...
const ComputerVision = () => {
  const solution = solutionDetails['computer-vision'];

  return (
    <PageLayout>
      <PageMeta 
        title="Computer Vision - AI Visual Intelligence Solutions"
        description="We provide computer vision systems that reduce defects by 85%. Los Angeles AI consultant specializing in visual intelligence for Southern California manufacturing."
        keywords="computer vision Los Angeles, AI visual inspection Southern California, quality control AI, object detection systems, AI vision solutions"
        canonical="https://elevatedai.co/solutions/computer-vision"
      />
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: solution.name, url: "https://elevatedai.com/solutions/computer-vision" }
        ]}
      />
      ...
      <SectionContainer background="default" padding="large" className="text-center">
        <div className="max-w-4xl mx-auto space-y-6 animate-on-scroll">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <Link to="/contact?solution=computer-vision">
      ...
      <SectionContainer background="gradient" padding="large">
        <div className="max-w-4xl mx-auto text-center space-y-6 animate-on-scroll">
          <Heading2>Ready to Deploy AI That Sees?</Heading2>
          <Body className="text-white/70 max-w-2xl mx-auto">
            Join leading companies using computer vision for quality control, safety monitoring, and inventory management.
          </Body>
